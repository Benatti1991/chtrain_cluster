...
class Policy(object):
    ...
    def __init__(self, obs_dim, act_dim, kl_targ, parallel_GPU=False):
        """
        Args:
        ...
        self.epochs = 20
        self.lr = None           # SB: lr = learning rate
        self.lr_multiplier = 1.0  # dynamically adjust lr when D_KL out of control
        self.obs_dim = obs_dim
        self.act_dim = act_dim
        self.savedmodel = os.path.isfile("./savedmodel/Policy/checkpoint") 
    ...
    def _loss_train_op(self):
        ...
        #il loss 3 è stato aggiunto a posteriori. v. sito di coady
    ...
    def _restore_model(self):
           ...
           loader = tf.train.import_meta_graph('./savedmodel/Policy/trained_variables.ckpt.meta')
           ...
           self.saver = tf.train.Saver()
           loader.restore(self.sess, tf.train.latest_checkpoint('./savedmodel/Policy'))
    ...
    def update(self, observes, actions, advantages, logger):
        ...
        self.saver.save(self.sess, "./savedmodel/Policy/trained_variables.ckpt")
    ...
    def close_sess(self):
        #self.saver.save(self.sess, "./savedmodel/Policy/final_variables.ckpt")
