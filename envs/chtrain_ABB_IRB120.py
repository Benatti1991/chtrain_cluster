...
class Model(object):
       def __init__(self, render):
              ...
              self.bodiesNames = ["Racer3_p01-1", "Racer3_p02-1", "Racer3_p03-1", "Racer3_p04-1", "Racer3_p05-1", "Racer3_p06-2", "Hand_base_and_p07-3"]
...
#              self.minRot = [-170, -95, -155, -179, -100, -179] # ° --> COMAU
              ...
              self.maxT = np.asarray([100, 100, 50, 7.36, 7.36, 4.41]) # --> LASCIATI UGUALI A COMAU
       ...
       def reset(self):
              ...
              self.hand = self.robosystem.SearchBody('Hand_base_and_p07-3')
              self.base  = self.robosystem.SearchBody('Racer3_p01-1')
              self.biceps  = self.robosystem.SearchBody('Racer3_p03-1')
              self.forearm  = self.robosystem.SearchBody('Racer3_p05-1')
              self.finger1 = self.robosystem.SearchBody('HAND_e_finger-2-1')
              self.finger2 = self.robosystem.SearchBody('HAND_e_finger-1-3')
