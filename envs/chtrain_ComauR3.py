...
class Model(object):
       ...
       def calc_rew(self):
              ...
              fing_con =  0 if self.finger1.GetContactForce().Length()+ self.finger2.GetContactForce().Length() == 0 else -50 - (self.finger1.GetContactForce().Length() + self.finger2.GetContactForce().Length())
