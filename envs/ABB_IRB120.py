...
body_1.SetName('HAND_e_finger-2-1')
body_1.SetPos(chrono.ChVectorD(-0.449700001879166,0.629999999999998,-0.00974999999995428))
body_1.SetRot(chrono.ChQuaternionD(0.707106781186548,-1.37140828284124e-16,-8.71576399210525e-33,0.707106781186547))
body_1.SetMass(0.0938874355859725)
body_1.SetInertiaXX(chrono.ChVectorD(3.31467659305197e-05,2.45303153855084e-05,3.6800601429295e-05))
body_1.SetInertiaXY(chrono.ChVectorD(-4.73444367209372e-06,-1.65947246859143e-06,-7.80569347513243e-06))
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.00724737975140957,0.0206478134281555,0.0224215440569809),chrono.ChQuaternionD(1,0,0,0)))
...
body_1.GetCollisionModel().AddBox(0.0104999999999594,0.01,0.003,chrono.ChVectorD(-1.00000000174933E-05,0.0501000000000003,0.0279999999999993),mr)
...
body_2.SetName('HAND_e_finger-1-3')
body_2.SetPos(chrono.ChVectorD(-0.449700001879166,0.629999999999998,-0.00974999999995428))
body_2.SetRot(chrono.ChQuaternionD(0.707106781186548,1.74315279842105e-32,-1.37140828284124e-16,0.707106781186547))
body_2.SetMass(0.0938874355859725)
body_2.SetInertiaXX(chrono.ChVectorD(3.31466514037026e-05,2.45304814291191e-05,3.68005499125014e-05))
body_2.SetInertiaXY(chrono.ChVectorD(4.73448371552155e-06,-1.6596537866072e-06,7.80573433834422e-06))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.00724735083156416,0.020647536888227,-0.022421500455029),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.GetCollisionModel().AddBox(0.00999999999998747,0.01,0.00300000000000004,chrono.ChVectorD(-0.000489999999987308,0.0501000000000003,-0.0279999999999992),mr)
...
body_3.SetName('Hand_base_and_p07-3')
body_3.SetPos(chrono.ChVectorD(-0.449700001879166,0.629999999999998,-0.00974999999995428))
body_3.SetRot(chrono.ChQuaternionD(-6.8570414142062e-17,0.707106781186548,-0.707106781186547,6.8570414142062e-17))
body_3.SetMass(0.38232347669012)
body_3.SetInertiaXX(chrono.ChVectorD(0.000560005407272658,0.000562334354846062,0.000200649640246989))
body_3.SetInertiaXY(chrono.ChVectorD(6.41346215573423e-10,1.55107482746673e-07,-1.57001286264211e-06))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.94804546979808e-07,-0.0397712704827772,7.29741759192392e-05),chrono.ChQuaternionD(1,0,0,0)))
...
body_5.SetName('Racer3_p03-1')
body_5.SetPos(chrono.ChVectorD(9.56474296423016e-13,0.559999999999997,0.057749999999956))
body_5.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_5.SetMass(10.3728089874946)
body_5.SetInertiaXX(chrono.ChVectorD(0.135351163523564,0.176351507859371,0.0662572827719947))
body_5.SetInertiaXY(chrono.ChVectorD(6.67046202009325e-05,4.53808512459234e-05,0.00356008428611989))
body_5.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.000779225680825848,-0.168753274058432,-0.0558835115362147),chrono.ChQuaternionD(1,0,0,0)))
...
body_5.GetCollisionModel().AddBox(0.0395,0.036,0.0587499999999994,chrono.ChVectorD(0.00574444444444444,-0.15,-0.0587499999999994),mr)
...
body_6.SetPos(chrono.ChVectorD(-0.071952844980859,0.493846097658507,-0.00974999999991896))
...
body_7.SetName('Racer3_p05-1')
body_7.SetPos(chrono.ChVectorD(-0.301999999999166,0.629999999999998,-0.00974999999995427))
body_7.SetRot(chrono.ChQuaternionD(5.71683110376037e-17,-5.55111512312578e-17,1,-1.23259516440783e-32))
body_7.SetMass(4.23269774636928)
body_7.SetInertiaXX(chrono.ChVectorD(0.00874186762217474,0.0294932955860917,0.0293132947008589))
body_7.SetInertiaXY(chrono.ChVectorD(0.000146905448408953,-0.00243433071013402,1.62260275620461e-05))
body_7.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.0757866568886516,0.000371805945289896,0.00456599373754589),chrono.ChQuaternionD(1,0,0,0)))
...
body_7.GetCollisionModel().AddCylinder(0.041,0.041,0.062,chrono.ChVectorD(-9.42688781739109E-29,0,-5.01682029252493E-15),mr)
...
body_8.SetName('Racer3_p06-2')
body_8.SetPos(chrono.ChVectorD(8.37885316684606e-13,-2.4980018054066e-15,-0.00974999999995417))
body_8.SetRot(chrono.ChQuaternionD(1.17961196366423e-16,-2.77555756156289e-17,1,-6.22460558025955e-30))
body_8.SetMass(2.10059663848927)
body_8.SetInertiaXX(chrono.ChVectorD(0.00108999246895887,0.00212848592492114,0.0020609403503579))
body_8.SetInertiaXY(chrono.ChVectorD(-2.14165623203743e-06,3.2224257157417e-06,2.2813841512309e-08))
body_8.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.300905163754392,0.630062216798406,-3.68522501256792e-05),chrono.ChQuaternionD(1,0,0,0)))
...
#   Entity 1: C::E name: body_5 , SW name: Racer3_p03-1 ,  SW ref.type:2 (2)

link_5 = chrono.ChLinkMateParallel()
cA = chrono.ChVectorD(-6.14352493113471e-14,0.29,-0.240519335983782)
dA = chrono.ChVectorD(0,0,1)
cB = chrono.ChVectorD(9.55888006202525e-13,0.289999999999998,0.0597499999999645)
...
#   Entity 1: C::E name: body_5 , SW name: Racer3_p03-1 ,  SW ref.type:4 (4)

link_7 = chrono.ChLinkMateXdistance()
cA = chrono.ChVectorD(0,0,0)
cB = chrono.ChVectorD(9.55948067430297e-13,0.559999999999997,-3.88716836496883e-14)
dA = chrono.ChVectorD(0,0,1)
...
#   Entity 0: C::E name: body_5 , SW name: Racer3_p03-1 ,  SW ref.type:2 (2)
#   Entity 1: C::E name: body_6 , SW name: Racer3_p04-1 ,  SW ref.type:2 (2)

link_9 = chrono.ChLinkMateParallel()
cA = chrono.ChVectorD(9.55691288560349e-13,0.559999999999998,0.059749999999964)
dA = chrono.ChVectorD(1.82243807002376e-14,4.89069225964583e-17,1)
cB = chrono.ChVectorD(8.30516211358656e-13,0.559999999999947,-0.197342929112484)
...
cA = chrono.ChVectorD(0.0572530248465829,0.357253820140855,-0.0597500000000429)
cB = chrono.ChVectorD(8.33000335376255e-13,0.559999999999947,-0.0597499999999202)
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(-1.80861286389938e-14,-2.43904717866781e-16,-1)
...
#   Entity 1: C::E name: body_7 , SW name: Racer3_p05-1 ,  SW ref.type:2 (2)

link_13 = chrono.ChLinkMateParallel()
cA = chrono.ChVectorD(500.000000000001,0.629999999999947,-0.0097500000089633)
...
link_13.Initialize(body_6,body_7,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-1,-3.31053967256856e-32,1.80861286389938e-14)
dB = chrono.ChVectorD(1,1.11022302462516e-16,1.14336622075207e-16)
link_14.Initialize(body_6,body_7,False,cA,cB,dA,dB)
...
cA = chrono.ChVectorD(-0.149599999999166,0.629999999999947,-0.009749999999979)
...
link_15.Initialize(body_6,body_7,False,cA,cB,dB)
...
link_16.Initialize(body_6,body_7,False,cA,cB,dA,dB)
...
#   Entity 0: C::E name: body_7 , SW name: Racer3_p05-1 ,  SW ref.type:2 (2)
#   Entity 1: C::E name: body_8 , SW name: Racer3_p06-2 ,  SW ref.type:2 (2)
...
link_17.Initialize(body_7,body_8,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-1.14336622075208e-16,2.46519032881566e-32,1)
dB = chrono.ChVectorD(2.35922392732846e-16,-1.24492111605191e-29,-1)
link_19.Initialize(body_7,body_8,False,cA,cB,dB)
...
link_20.Initialize(body_7,body_8,False,cA,cB,dA,dB)
...
#   Entity 0: C::E name: body_8 , SW name: Racer3_p06-2 ,  SW ref.type:2 (2)
#   Entity 1: C::E name: body_3 , SW name: Hand_base_and_p07-3 ,  SW ref.type:2 (2)
...
#   Entity 0: C::E name: body_3 , SW name: Hand_base_and_p07-3 ,  SW ref.type:4 (4)
#   Entity 1: C::E name: body_2 , SW name: HAND_e_finger-1-3 ,  SW ref.type:4 (4)
...
dB = chrono.ChVectorD(-1,-6.15242222082669e-17,-1.93946419314488e-16)
link_27.Initialize(body_3,body_2,False,cA,cB,dB)
...
cB = chrono.ChVectorD(-0.449700001879166,0.629999999999998,-0.00974999999995428)
dB = chrono.ChVectorD(-1,-6.15242222082669e-17,-1.93946419314488e-16)
link_28.Initialize(body_3,body_2,False,cA,cB,dA,dB)
...
link_29.Initialize(body_3,body_2,False,cA,cB,dB)
...
link_30.Initialize(body_3,body_2,False,cA,cB,dA,dB)
...
#   Entity 0: C::E name: body_3 , SW name: Hand_base_and_p07-3 ,  SW ref.type:4 (4)
#   Entity 1: C::E name: body_1 , SW name: HAND_e_finger-2-1 ,  SW ref.type:4 (4)
...
dA = chrono.ChVectorD(1.93946419314488e-16,0,-1)
dB = chrono.ChVectorD(-1.93946419314488e-16,1.93946419314488e-16,1)
link_31.Initialize(body_3,body_1,False,cA,cB,dB)
...
link_32.Initialize(body_3,body_1,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-1,-6.15242222082669e-17,-1.93946419314488e-16)
dB = chrono.ChVectorD(-1,-6.15242222082669e-17,-1.93946419314488e-16)
link_33.Initialize(body_3,body_1,False,cA,cB,dB)
...
cB = chrono.ChVectorD(-0.449700001879166,0.629999999999998,-0.00974999999995428)
dB = chrono.ChVectorD(-1,-6.15242222082669e-17,-1.93946419314488e-16)
link_34.Initialize(body_3,body_1,False,cA,cB,dA,dB)
...
link_35.Initialize(body_3,body_1,False,cA,cB,dB)
...
link_36.Initialize(body_3,body_1,False,cA,cB,dA,dB)
...
#   Entity 0: C::E name: body_5 , SW name: Racer3_p03-1 ,  SW ref.type:4 (4)
...
#   Entity 0: C::E name: body_6 , SW name: Racer3_p04-1 ,  SW ref.type:4 (4)
#   Entity 1: C::E name: body_7 , SW name: Racer3_p05-1 ,  SW ref.type:4 (4)


# Mate constraint: Angle5 [MatePlanarAngleDim] type:6 align:0 flip:False
#   Entity 0: C::E name: body_8 , SW name: Racer3_p06-2 ,  SW ref.type:4 (4)
#   Entity 1: C::E name: body_7 , SW name: Racer3_p05-1 ,  SW ref.type:4 (4)


# Mate constraint: Angle6 [MatePlanarAngleDim] type:6 align:0 flip:False
#   Entity 0: C::E name: body_8 , SW name: Racer3_p06-2 ,  SW ref.type:4 (4)
#   Entity 1: C::E name: body_3 , SW name: Hand_base_and_p07-3 ,  SW ref.type:4 (4)
