...
class NNValueFunction(object):
    ...
    def __init__(self, obs_dim, MultiGPU = False):
        """
        Args:
        ...
        self.savedmodel = os.path.isfile("./savedmodel/VF/checkpoint")
        if self.savedmodel :
               self._restore()
        else:
               self._build_graph()
    ...
    def _restore(self):
           ...
           loader = tf.train.import_meta_graph('./savedmodel/VF/trained_VF.ckpt.meta')
           ...
           self.saverVF = tf.train.Saver()
           loader.restore(self.sess, tf.train.latest_checkpoint('./savedmodel/VF'))
    ...
    def fit(self, x, y, logger):
        ...
        self.saverVF.save(self.sess, "./savedmodel/VF/trained_VF.ckpt")
